...
System off… par kahani chalti ji…`},tr=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),z=o(((e,t)=>{t.exports=tr()}))(),nr=`/Koenigliche-AI-Songs/`,rr=e=>`${nr}${e}`,ir=`https://forms.gle/NSAUa8ifBkJxrHjn6`;function ar(e,t){return e===`albums`&&t?t.title:e===`songs`?`Songs`:e===`albums`?`Alben`:e===`patchnotes`?`Patchnotes`:`Startseite`}var or={background:`#1db954`,color:`white`,border:`none`,borderRadius:`999px`,padding:`10px 16px`,cursor:`pointer`,fontWeight:700},sr={background:`#1a1f2b`,color:`white`,border:`1px solid #2a3142`,borderRadius:`999px`,padding:`10px 16px`,cursor:`pointer`,fontWeight:700},cr={width:`100%`,background:`transparent`,color:`white`,border:`none`,textAlign:`left`,padding:`12px 14px`,cursor:`pointer`},lr={display:`block`,color:`white`,textDecoration:`none`,padding:`12px 14px`},ur=e=>({background:e?`#1db954`:`#171b24`,color:`white`,border:`none`,borderRadius:`14px`,padding:`14px 16px`,textAlign:`left`,cursor:`pointer`,fontWeight:700,width:`100%`});function dr(){let[e,t]=(0,_.useState)(`home`),[n,r]=(0,_.useState)(null),[i,a]=(0,_.useState)([]),[o,s]=(0,_.useState)([]),[c,l]=(0,_.useState)(null),[u,d]=(0,_.useState)(null),[f,p]=(0,_.useState)(!1),[m,h]=(0,_.useState)(!1),[g,v]=(0,_.useState)(null),[y,b]=(0,_.useState)(!1),[x,S]=(0,_.useState)(!1),[C,w]=(0,_.useState)(!1),[ee,T]=(0,_.useState)(0),[te,E]=(0,_.useState)(0),[D,ne]=(0,_.useState)(0),[re,ie]=(0,_.useState)(``),[O,ae]=(0,_.useState)(1),[oe,k]=(0,_.useState)(1),[A,se]=(0,_.useState)(!1),[ce,j]=(0,_.useState)(``),[M,N]=(0,_.useState)(`off`),[P,le]=(0,_.useState)(!1),F=(0,_.useRef)(null),de=(0,_.useMemo)(()=>{let e=re.trim().toLowerCase();return e?Qn.filter(t=>t.title.toLowerCase().includes(e)||t.artist.toLowerCase().includes(e)||(t.album||``).toLowerCase().includes(e)):Qn},[re]),I=(0,_.useMemo)(()=>[...Qn].sort((e,t)=>new Date(t.releaseDate)-new Date(e.releaseDate)).slice(0,5),[]),fe=(0,_.useMemo)(()=>{let e=new Map;return Qn.forEach(t=>{if(!t.album)return;e.has(t.album)||e.set(t.album,{id:t.album,title:t.album,artist:t.artist,cover:t.albumCover||t.cover,releaseDate:t.releaseDate,tracks:[]});let n=e.get(t.album);n.tracks.push(t),new Date(t.releaseDate)>new Date(n.releaseDate)&&(n.releaseDate=t.releaseDate)}),[...e.values()].map(e=>({...e,isAlbum:e.tracks.length>1,releaseType:e.tracks.length>1?`Album`:`Single`,tracks:[...e.tracks].sort((e,t)=>e.trackNumber-t.trackNumber)}))},[]),pe=(e,t={})=>{if(!e)return;let{fromHistory:i=!1,resetHistory:a=!1}=t;a?s([]):!i&&n&&s(e=>[...e,n]),r(e),l(null),setTimeout(()=>{F.current?.play().catch(()=>{})},50)},me=e=>{a([]),pe(e,{resetHistory:!0})},he=e=>{if(!e?.tracks?.length)return;let[n,...r]=[...e.tracks].sort((e,t)=>e.trackNumber-t.trackNumber);d(e),t(`albums`),a(r),pe(n,{resetHistory:!0})},ge=e=>{if(!e?.tracks?.length)return;let[n,...r]=[...e.tracks].sort((e,t)=>e.trackNumber-t.trackNumber).sort(()=>Math.random()-.5);d(e),t(`albums`),a(r),pe(n,{resetHistory:!0})},_e=()=>{if(!Qn.length)return;let[e,...t]=Qn;a(t),pe(e,{resetHistory:!0})},ve=()=>{if(!Qn.length)return;let[e,...t]=[...Qn].sort(()=>Math.random()-.5);a(t),pe(e,{resetHistory:!0})},ye=()=>{a([])},be=e=>{a(t=>[...t,e]),l(null)},xe=e=>{a(t=>t.filter((t,n)=>n!==e))},Se=we(Ce(Ct,{activationConstraint:{distance:8}})),Te=e=>{let{active:t,over:n}=e;!n||t.id===n.id||a(e=>{let r=e.findIndex((e,n)=>`${e.id}-${n}`===t.id),i=e.findIndex((e,t)=>`${e.id}-${t}`===n.id);return r===-1||i===-1?e:An(e,r,i)})},Ee=()=>{if(n){if(M===`one`){F.current&&(F.current.currentTime=0,F.current.play().catch(()=>{}));return}De()}},De=()=>{if(i.length>0){let[e,...t]=i;a(t),pe(e);return}if(M===`all`&&n){let e=[...o,n].filter(Boolean);if(e.length===0)return;let[t,...r]=e;s([]),a(r),pe(t,{fromHistory:!0})}},Oe=()=>{if(D>3&&F.current){F.current.currentTime=0,ne(0),T(0);return}if(o.length===0){F.current&&(F.current.currentTime=0,ne(0),T(0));return}let e=o[o.length-1];s(e=>e.slice(0,-1)),n&&a(e=>[n,...e]),pe(e,{fromHistory:!0})},ke=e=>{t(e),e!==`albums`&&d(null),p(!1)};(0,_.useEffect)(()=>{if(e===`home`){b(!1),S(!1),w(!1);let e=setTimeout(()=>{b(!0)},60),t=setTimeout(()=>{S(!0)},220),n=setTimeout(()=>{w(!0)},380);return()=>{clearTimeout(e),clearTimeout(t),clearTimeout(n)}}else b(!1),S(!1),w(!1)},[e]),(0,_.useEffect)(()=>{F.current&&(F.current.volume=O)},[O]),(0,_.useEffect)(()=>{if(`mediaSession`in navigator)return n&&(navigator.mediaSession.metadata=new MediaMetadata({title:n.title,artist:n.artist,album:n.album||`Königliche AI Songs`,artwork:[{src:n.cover,sizes:`96x96`,type:`image/jpeg`},{src:n.cover,sizes:`128x128`,type:`image/jpeg`},{src:n.cover,sizes:`192x192`,type:`image/jpeg`},{src:n.cover,sizes:`256x256`,type:`image/jpeg`},{src:n.cover,sizes:`384x384`,type:`image/jpeg`},{src:n.cover,sizes:`512x512`,type:`image/jpeg`}]})),navigator.mediaSession.setActionHandler(`play`,()=>{let e=F.current;e&&e.play().catch(()=>{})}),navigator.mediaSession.setActionHandler(`pause`,()=>{let e=F.current;e&&e.pause()}),navigator.mediaSession.setActionHandler(`nexttrack`,()=>{De()}),navigator.mediaSession.setActionHandler(`previoustrack`,()=>{Oe()}),()=>{try{navigator.mediaSession.setActionHandler(`play`,null),navigator.mediaSession.setActionHandler(`pause`,null),navigator.mediaSession.setActionHandler(`nexttrack`,null),navigator.mediaSession.setActionHandler(`previoustrack`,null)}catch(e){console.log(e)}}},[n,i,o,D]),(0,_.useEffect)(()=>{`mediaSession`in navigator&&(navigator.mediaSession.playbackState=m?`playing`:`paused`)},[m]),(0,_.useEffect)(()=>{let e=F.current;if(!e)return;e.volume=O;let t=()=>{let t=e.currentTime||0,n=e.duration||0;ne(t),E(n),T(n>0?t/n*100:0)},n=()=>{E(e.duration||0),t()},r=()=>h(!0),i=()=>h(!1),a=()=>{h(!1),Ee()};return e.addEventListener(`timeupdate`,t),e.addEventListener(`loadedmetadata`,n),e.addEventListener(`play`,r),e.addEventListener(`pause`,i),e.addEventListener(`ended`,a),t(),()=>{e.removeEventListener(`timeupdate`,t),e.removeEventListener(`loadedmetadata`,n),e.removeEventListener(`play`,r),e.removeEventListener(`pause`,i),e.removeEventListener(`ended`,a)}},[n,i,o,M,O]);let Ae=e=>{if(!Number.isFinite(e)||e<0)return`0:00`;let t=Math.floor(e/60),n=Math.floor(e%60);return`${t}:${String(n).padStart(2,`0`)}`},Me=()=>{let e=F.current;!e||!n||(e.paused?e.play().catch(()=>{}):e.pause())},Ne=e=>{let t=F.current;if(!t||!te)return;let n=Number(e.target.value),r=n/100*te;t.currentTime=r,T(n),ne(r)},Pe=()=>{n&&(j(er[n.title]||`Für diesen Song ist noch kein Liedtext hinterlegt.`),se(!0))},Fe=()=>{O===0?ae(oe>0?oe:1):(k(O),ae(0))},Ie=()=>{N(e=>e===`off`?`all`:e===`all`?`one`:`off`)},Le=({id:e,song:t,index:n,removeFromQueue:r})=>{let{attributes:i,listeners:a,setNodeRef:o,transform:s,transition:c,isDragging:l}=Yn({id:e});return(0,z.jsxs)(`div`,{ref:o,style:{transform:ue.Transform.toString(s),transition:c,background:l?`#1a2230`:`#141821`,borderRadius:`12px`,padding:`10px`,display:`grid`,gridTemplateColumns:`24px 1fr 32px`,gap:`10px`,alignItems:`center`,border:l?`1px solid #3a455a`:`1px solid transparent`},children:[(0,z.jsx)(`button`,{...i,...a,style:gr(l),children:`⋮⋮`}),(0,z.jsxs)(`div`,{style:{minWidth:0},children:[(0,z.jsx)(`div`,{style:{fontSize:`14px`,fontWeight:700,whiteSpace:`nowrap`,overflow:`hidden`,textOverflow:`ellipsis`},children:t.title}),(0,z.jsx)(`div`,{style:{color:`#8f8f8f`,fontSize:`13px`,whiteSpace:`nowrap`,overflow:`hidden`,textOverflow:`ellipsis`},children:t.artist})]}),(0,z.jsx)(`button`,{onClick:()=>r(n),style:_r,children:`✕`})]})},Re=({song:e,index:r,showAlbum:i=!0})=>(0,z.jsxs)(`div`,{onClick:()=>me(e),onMouseEnter:()=>v(`song-row-${e.id}`),onMouseLeave:()=>v(null),style:{display:`grid`,gridTemplateColumns:`40px 56px minmax(220px, 1.8fr) minmax(160px, 1fr) 90px 48px`,gap:`14px`,alignItems:`center`,padding:`12px 16px`,borderRadius:`14px`,background:n?.id===e.id?`rgba(29,185,84,0.12)`:g===`song-row-${e.id}`?`rgba(255,255,255,0.05)`:`transparent`,border:n?.id===e.id?`1px solid rgba(29,185,84,0.35)`:g===`song-row-${e.id}`?`1px solid rgba(255,255,255,0.08)`:`1px solid transparent`,position:`relative`,cursor:`pointer`,transition:`background 0.15s ease, border 0.15s ease`},children:[(0,z.jsx)(`div`,{style:{color:`#8f8f8f`,fontSize:`14px`},children:r+1}),(0,z.jsx)(`img`,{src:e.cover,alt:e.title,style:{width:`56px`,height:`56px`,objectFit:`cover`,borderRadius:`10px`}}),(0,z.jsxs)(`div`,{style:{minWidth:0},children:[(0,z.jsx)(`div`,{style:{fontWeight:700,whiteSpace:`nowrap`,overflow:`hidden`,textOverflow:`ellipsis`,color:`white`},children:e.title}),(0,z.jsx)(`div`,{style:{color:`#a0a0a0`,fontSize:`14px`,whiteSpace:`nowrap`,overflow:`hidden`,textOverflow:`ellipsis`,cursor:`default`},children:e.artist})]}),(0,z.jsx)(`div`,{onClick:n=>{if(n.stopPropagation(),!e.album)return;let r=fe.find(t=>t.title===e.album);r&&(d(r),t(`albums`))},onMouseEnter:()=>v(`song-album-${e.id}`),onMouseLeave:()=>v(null),style:{color:g===`song-album-${e.id}`?`#ffffff`:`#b0b0b0`,fontSize:`14px`,whiteSpace:`nowrap`,overflow:`hidden`,textOverflow:`ellipsis`,cursor:e.album?`pointer`:`default`,textDecoration:g===`song-album-${e.id}`&&e.album?`underline`:`none`,transition:`color 0.15s ease`},children:e.album||`—`}),(0,z.jsx)(`div`,{style:{color:`#9a9a9a`,fontSize:`14px`},children:e.duration}),(0,z.jsxs)(`div`,{style:{position:`relative`},children:[(0,z.jsx)(`button`,{onClick:t=>{t.stopPropagation(),l(c===e.id?null:e.id)},style:{width:`38px`,height:`38px`,borderRadius:`999px`,border:`none`,background:`#242424`,color:`white`,cursor:`pointer`,fontSize:`18px`},children:`⋯`}),c===e.id&&(0,z.jsxs)(`div`,{onClick:e=>e.stopPropagation(),style:{position:`absolute`,right:0,top:`46px`,background:`#171717`,border:`1px solid #2e2e2e`,borderRadius:`14px`,overflow:`hidden`,minWidth:`190px`,zIndex:20,boxShadow:`0 12px 30px rgba(0,0,0,0.35)`},children:[(0,z.jsx)(`button`,{onClick:()=>be(e),style:cr,children:`Als Nächstes abspielen`}),(0,z.jsx)(`a`,{href:e.file,download:!0,style:lr,children:`Download`})]})]})]},e.id+`-`+r);return(0,z.jsxs)(`div`,{style:{minHeight:`100vh`,background:`#0d0f16`,color:`white`,fontFamily:`Arial, sans-serif`,paddingBottom:`130px`},children:[(0,z.jsx)(`header`,{style:{position:`sticky`,top:0,zIndex:30,background:`rgba(13,15,22,0.88)`,backdropFilter:`blur(12px)`,borderBottom:`1px solid #1f2430`},children:(0,z.jsxs)(`div`,{style:{width:`100%`,padding:`18px 26px`,boxSizing:`border-box`,display:`flex`,alignItems:`center`,justifyContent:`space-between`,gap:`20px`},children:[(0,z.jsxs)(`div`,{onClick:()=>{t(`home`),d(null),p(!1)},style:{cursor:`pointer`},children:[(0,z.jsx)(`div`,{style:{fontSize:`15px`,color:`#8e96a3`,marginBottom:`4px`},children:`Lokale Musikbibliothek`}),(0,z.jsx)(`div`,{style:{fontSize:`30px`,fontWeight:800},children:`Königliche AI Songs`})]}),(0,z.jsx)(`button`,{onClick:()=>p(!0),style:{width:`52px`,height:`52px`,borderRadius:`16px`,border:`1px solid #2a3142`,background:`#171b24`,color:`white`,cursor:`pointer`,fontSize:`22px`,fontWeight:700},children:`☰`})]})}),f&&(0,z.jsxs)(z.Fragment,{children:[(0,z.jsx)(`div`,{onClick:()=>p(!1),style:{position:`fixed`,inset:0,background:`rgba(0,0,0,0.45)`,zIndex:39}}),(0,z.jsxs)(`aside`,{style:{position:`fixed`,top:0,right:0,width:`360px`,maxWidth:`92vw`,height:`100vh`,background:`#111318`,borderLeft:`1px solid #202636`,zIndex:40,padding:`24px`,paddingBottom:`220px`,overflowY:`auto`,boxShadow:`-18px 0 40px rgba(0,0,0,0.45)`},children:[(0,z.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`space-between`,marginBottom:`24px`},children:[(0,z.jsxs)(`div`,{children:[(0,z.jsx)(`div`,{style:{fontSize:`14px`,color:`#8e96a3`,marginBottom:`4px`},children:`Menü`}),(0,z.jsx)(`div`,{style:{fontSize:`26px`,fontWeight:800},children:`Königliche AI Songs`})]}),(0,z.jsx)(`button`,{onClick:()=>p(!1),style:{width:`42px`,height:`42px`,borderRadius:`12px`,border:`1px solid #2a3142`,background:`#171b24`,color:`white`,cursor:`pointer`,fontSize:`18px`},children:`✕`})]}),(0,z.jsxs)(`div`,{style:{display:`grid`,gap:`10px`,marginBottom:`30px`},children:[(0,z.jsx)(`button`,{onClick:()=>ke(`home`),style:ur(e===`home`),children:`Startseite`}),(0,z.jsx)(`button`,{onClick:()=>ke(`songs`),style:ur(e===`songs`),children:`Songs`}),(0,z.jsx)(`button`,{onClick:()=>ke(`albums`),style:ur(e===`albums`&&!u),children:`Alben`}),(0,z.jsx)(`button`,{onClick:()=>ke(`patchnotes`),style:ur(e===`patchnotes`),children:`Patchnotes`}),(0,z.jsx)(`button`,{onClick:()=>{le(!0),p(!1)},style:ur(!1),children:`Song einreichen`})]}),(0,z.jsxs)(`div`,{children:[(0,z.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`center`,marginBottom:`10px`},children:[(0,z.jsx)(`div`,{style:{color:`#8e96a3`,fontSize:`13px`,textTransform:`uppercase`,letterSpacing:`0.08em`,fontWeight:700},children:`Warteschlange`}),(0,z.jsx)(`button`,{onClick:ye,style:{background:`transparent`,border:`none`,color:`#c7ced9`,cursor:`pointer`,fontSize:`13px`},children:`Löschen`})]}),(0,z.jsx)(`div`,{style:{display:`grid`,gap:`8px`,paddingBottom:`50px`},children:i.length===0?(0,z.jsx)(`div`,{style:{color:`#8f8f8f`,fontSize:`14px`},children:`Noch nichts vorgemerkt.`}):(0,z.jsx)(xn,{sensors:Se,collisionDetection:je,onDragEnd:Te,children:(0,z.jsx)(Vn,{items:i.map((e,t)=>`${e.id}-${t}`),strategy:Ln,children:(0,z.jsx)(`div`,{style:{display:`grid`,gap:`8px`},children:i.map((e,t)=>(0,z.jsx)(Le,{id:`${e.id}-${t}`,song:e,index:t,removeFromQueue:xe},`${e.id}-${t}`))})})})})]})]})]}),(0,z.jsxs)(`main`,{style:{width:`100%`,padding:`26px 40px`,boxSizing:`border-box`},children:[e===`home`&&(0,z.jsxs)(z.Fragment,{children:[(0,z.jsxs)(`section`,{style:{minHeight:`220px`,borderRadius:`28px`,padding:`32px 48px`,backgroundImage:`linear-gradient(rgba(8,10,17,0.45), rgba(8,10,17,0.82)), url('${rr(`covers/Koenigliche-AI-Songs.png`)}')`,backgroundSize:`cover`,backgroundRepeat:`no-repeat`,backgroundPosition:`top center`,display:`flex`,flexDirection:`column`,justifyContent:`flex-end`,marginBottom:`28px`,opacity:+!!y,transform:y?`translateY(0px)`:`translateY(18px)`,transition:`opacity 0.45s ease, transform 0.45s ease`},children:[(0,z.jsx)(`div`,{style:{color:`#d0d7e2`,fontSize:`14px`,marginBottom:`10px`,letterSpacing:`0.08em`,textTransform:`uppercase`},children:`Startmenü`}),(0,z.jsx)(`h1`,{style:{fontSize:`44px`,margin:0,marginBottom:`10px`,maxWidth:`900px`,textAlign:`center`,width:`100%`},children:`Königliche AI Songs`}),(0,z.jsx)(`p`,{style:{maxWidth:`840px`,color:`#e3e6eb`,fontSize:`16px`,lineHeight:1.4,margin:`0 auto`,textAlign:`center`},children:`Deine AI-Musikbibliothek, zertifiziert von dem MM.`})]}),(0,z.jsxs)(`section`,{style:{opacity:+!!x,transform:x?`translateY(0px)`:`translateY(18px)`,transition:`opacity 0.45s ease, transform 0.45s ease`},children:[(0,z.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`space-between`,marginBottom:`16px`,gap:`16px`,flexWrap:`wrap`},children:[(0,z.jsx)(`h2`,{style:{margin:0},children:`Neueste Releases`}),(0,z.jsx)(`button`,{onClick:()=>t(`songs`),style:sr,children:`Alle Songs ansehen`})]}),(0,z.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(auto-fit, minmax(190px, 1fr))`,gap:`16px`},children:I.map(e=>(0,z.jsxs)(`button`,{onClick:()=>me(e),onMouseEnter:()=>v(`release-${e.id}`),onMouseLeave:()=>v(null),style:{textAlign:`left`,background:g===`release-${e.id}`?`#1a2230`:`#141821`,border:`1px solid #202636`,borderRadius:`20px`,padding:`14px`,color:`white`,cursor:`pointer`,minWidth:0,transform:g===`release-${e.id}`?`translateY(-4px) scale(1.02)`:`translateY(0) scale(1)`,boxShadow:g===`release-${e.id}`?`0 14px 30px rgba(0,0,0,0.35)`:`0 0 0 rgba(0,0,0,0)`,transition:`transform 0.18s ease, box-shadow 0.18s ease, background 0.18s ease`},children:[(0,z.jsx)(`img`,{src:e.cover,alt:e.title,style:{width:`100%`,aspectRatio:`1 / 1`,objectFit:`cover`,borderRadius:`14px`,marginBottom:`12px`}}),(0,z.jsx)(`div`,{style:{fontWeight:700,marginBottom:`6px`,lineHeight:1.2},children:e.title}),(0,z.jsx)(`div`,{style:{color:`#9aa2ad`,fontSize:`14px`},children:e.artist})]},e.id))})]}),(0,z.jsxs)(`section`,{style:{marginTop:`32px`,opacity:+!!C,transform:C?`translateY(0px)`:`translateY(18px)`,transition:`opacity 0.45s ease, transform 0.45s ease`},children:[(0,z.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`space-between`,marginBottom:`16px`,gap:`16px`,flexWrap:`wrap`},children:[(0,z.jsx)(`h2`,{style:{margin:0},children:`Aktuelle Alben`}),(0,z.jsx)(`button`,{onClick:()=>t(`albums`),style:sr,children:`Alle Alben ansehen`})]}),(0,z.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(auto-fit, minmax(220px, 1fr))`,gap:`18px`},children:fe.map(e=>(0,z.jsxs)(`button`,{onClick:()=>{d(e),t(`albums`)},onMouseEnter:()=>v(`home-album-${e.id}`),onMouseLeave:()=>v(null),style:{textAlign:`left`,background:g===`home-album-${e.id}`?`#1a2230`:`#141821`,border:`1px solid #202636`,borderRadius:`22px`,padding:`16px`,color:`white`,cursor:`pointer`,transform:g===`home-album-${e.id}`?`translateY(-4px) scale(1.02)`:`translateY(0) scale(1)`,boxShadow:g===`home-album-${e.id}`?`0 14px 30px rgba(0,0,0,0.35)`:`0 0 0 rgba(0,0,0,0)`,transition:`transform 0.18s ease, box-shadow 0.18s ease, background 0.18s ease`},children:[(0,z.jsx)(`img`,{src:e.cover,alt:e.title,style:{width:`100%`,aspectRatio:`1 / 1`,objectFit:`cover`,borderRadius:`16px`,marginBottom:`14px`}}),(0,z.jsx)(`div`,{style:{fontWeight:800,fontSize:`16px`,marginBottom:`6px`,lineHeight:1.2},children:e.title}),(0,z.jsx)(`div`,{style:{color:`#9aa2ad`,fontSize:`14px`},children:e.artist})]},e.id))})]})]}),e===`songs`&&(0,z.jsxs)(`section`,{children:[(0,z.jsxs)(`div`,{style:{marginBottom:`18px`},children:[(0,z.jsx)(`div`,{style:{color:`#8e96a3`,fontSize:`14px`,marginBottom:`6px`},children:`Bibliothek`}),(0,z.jsx)(`h1`,{style:{margin:0,marginBottom:`16px`},children:ar(e,u)}),(0,z.jsxs)(`div`,{style:{display:`flex`,gap:`10px`,flexWrap:`wrap`,marginBottom:`14px`},children:[(0,z.jsx)(`button`,{onClick:_e,style:or,children:`Play`}),(0,z.jsx)(`button`,{onClick:ve,style:sr,children:`Shuffle`})]}),(0,z.jsx)(`input`,{type:`text`,value:re,onChange:e=>ie(e.target.value),placeholder:`Suche nach Titel, Artist oder Album...`,style:{width:`100%`,maxWidth:`420px`,background:`#141821`,border:`1px solid #202636`,borderRadius:`14px`,padding:`12px 14px`,color:`white`,outline:`none`,fontSize:`14px`,boxSizing:`border-box`}})]}),(0,z.jsxs)(`div`,{style:{display:`grid`,gap:`8px`},children:[(0,z.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`40px 56px minmax(220px, 1.8fr) minmax(160px, 1fr) 90px 48px`,gap:`14px`,padding:`0 16px 8px`,color:`#8e96a3`,fontSize:`13px`,textTransform:`uppercase`,letterSpacing:`0.06em`},children:[(0,z.jsx)(`div`,{children:`#`}),(0,z.jsx)(`div`,{}),(0,z.jsx)(`div`,{children:`Titel`}),(0,z.jsx)(`div`,{children:`Album`}),(0,z.jsx)(`div`,{children:`Dauer`}),(0,z.jsx)(`div`,{}),(0,z.jsx)(`div`,{})]}),de.map((e,t)=>(0,z.jsx)(Re,{song:e,index:t,showAlbum:!0},e.id)),de.length===0&&(0,z.jsx)(`div`,{style:{color:`#8e96a3`,padding:`20px 16px`,borderRadius:`14px`,background:`#141821`,border:`1px solid #202636`},children:`Keine Songs gefunden.`})]})]}),e===`patchnotes`&&(0,z.jsxs)(`section`,{children:[(0,z.jsxs)(`div`,{style:{marginBottom:`18px`},children:[(0,z.jsx)(`div`,{style:{color:`#8e96a3`,fontSize:`14px`,marginBottom:`6px`},children:`Info`}),(0,z.jsx)(`h1`,{style:{margin:0,marginBottom:`16px`},children:`Patchnotes`})]}),(0,z.jsx)(`div`,{style:{display:`grid`,gap:`18px`},children:$n.map((e,t)=>(0,z.jsxs)(`div`,{style:{background:`#141821`,border:`1px solid #202636`,borderRadius:`22px`,padding:`24px`,color:`#d7dce4`},children:[(0,z.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`center`,gap:`12px`,marginBottom:`14px`,flexWrap:`wrap`},children:[(0,z.jsxs)(`div`,{style:{fontWeight:800,fontSize:`22px`},children:[`Version `,e.version]}),(0,z.jsx)(`div`,{style:{color:`#8e96a3`,fontSize:`14px`},children:e.label||(t===0?`Aktueller Patch`:`Früherer Patch`)})]}),(0,z.jsx)(`ul`,{style:{margin:0,paddingLeft:`20px`,lineHeight:1.9},children:e.changes.map((e,t)=>(0,z.jsx)(`li`,{children:e},t))})]},e.version))})]}),e===`albums`&&!u&&(0,z.jsxs)(`section`,{children:[(0,z.jsxs)(`div`,{style:{marginBottom:`18px`},children:[(0,z.jsx)(`div`,{style:{color:`#8e96a3`,fontSize:`14px`,marginBottom:`6px`},children:`Bibliothek`}),(0,z.jsx)(`h1`,{style:{margin:0},children:`Alben`})]}),(0,z.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(2, minmax(0, 1fr))`,gap:`18px`},children:fe.map(e=>(0,z.jsxs)(`div`,{onMouseEnter:()=>v(`albums-page-${e.id}`),onMouseLeave:()=>v(null),style:{background:g===`albums-page-${e.id}`?`#1a2230`:`#141821`,border:`1px solid #202636`,borderRadius:`22px`,padding:`16px`,minWidth:0,transform:g===`albums-page-${e.id}`?`translateY(-4px) scale(1.02)`:`translateY(0) scale(1)`,boxShadow:g===`albums-page-${e.id}`?`0 14px 30px rgba(0,0,0,0.35)`:`0 0 0 rgba(0,0,0,0)`,transition:`transform 0.18s ease, box-shadow 0.18s ease, background 0.18s ease`},children:[(0,z.jsx)(`img`,{src:e.cover,alt:e.title,style:{width:`100%`,aspectRatio:`1 / 1`,objectFit:`cover`,borderRadius:`16px`,marginBottom:`14px`}}),(0,z.jsx)(`div`,{style:{fontWeight:800,fontSize:`18px`,marginBottom:`6px`,lineHeight:1.15,wordBreak:`break-word`},children:e.title}),(0,z.jsx)(`div`,{style:{color:`#9aa2ad`,fontSize:`14px`,marginBottom:`8px`},children:e.artist}),(0,z.jsxs)(`div`,{style:{color:`#8f8f8f`,fontSize:`14px`,marginBottom:`14px`},children:[e.tracks.length,` `,e.tracks.length===1?`Track`:`Tracks`,` · `,e.releaseType]}),(0,z.jsxs)(`div`,{style:{display:`flex`,gap:`10px`,flexWrap:`wrap`},children:[(0,z.jsx)(`button`,{onClick:()=>he(e),style:or,children:`Play`}),(0,z.jsx)(`button`,{onClick:()=>{d(e),t(`albums`)},style:sr,children:`Öffnen`})]})]},e.id))})]}),e===`albums`&&u&&(0,z.jsxs)(`section`,{children:[(0,z.jsx)(`button`,{onClick:()=>d(null),style:{...sr,marginBottom:`16px`},children:`← Zurück zu Alben`}),(0,z.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`minmax(220px, 280px) minmax(0, 1fr)`,gap:`24px`,alignItems:`end`,background:`linear-gradient(180deg, #1b2130 0%, #10141d 100%)`,borderRadius:`26px`,padding:`22px`,marginBottom:`22px`},children:[(0,z.jsx)(`img`,{src:u.cover,alt:u.title,style:{width:`100%`,aspectRatio:`1 / 1`,objectFit:`cover`,borderRadius:`20px`}}),(0,z.jsxs)(`div`,{style:{minWidth:0},children:[(0,z.jsx)(`div`,{style:{color:`#c2cad6`,fontSize:`14px`,textTransform:`uppercase`,letterSpacing:`0.08em`,marginBottom:`10px`},children:u.releaseType}),(0,z.jsx)(`h1`,{style:{fontSize:`clamp(34px, 4vw, 56px)`,margin:0,marginBottom:`10px`,lineHeight:.95,maxWidth:`780px`,wordBreak:`break-word`},children:u.title}),(0,z.jsx)(`div`,{style:{color:`#d7dce4`,marginBottom:`8px`},children:u.artist}),(0,z.jsxs)(`div`,{style:{color:`#9aa2ad`,marginBottom:`18px`},children:[u.tracks.length,` `,u.tracks.length===1?`Track`:`Tracks`]}),(0,z.jsxs)(`div`,{style:{display:`flex`,gap:`10px`,flexWrap:`wrap`},children:[(0,z.jsx)(`button`,{onClick:()=>he(u),style:or,children:`Play`}),(0,z.jsx)(`button`,{onClick:()=>ge(u),style:sr,children:`Shuffle`})]})]})]}),(0,z.jsxs)(`div`,{style:{display:`grid`,gap:`8px`},children:[(0,z.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`40px 56px minmax(220px, 1.8fr) minmax(160px, 1fr) 90px 48px`,gap:`14px`,padding:`0 16px 8px`,color:`#8e96a3`,fontSize:`13px`,textTransform:`uppercase`,letterSpacing:`0.06em`},children:[(0,z.jsx)(`div`,{children:`#`}),(0,z.jsx)(`div`,{}),(0,z.jsx)(`div`,{children:`Titel`}),(0,z.jsx)(`div`,{children:`Album`}),(0,z.jsx)(`div`,{children:`Dauer`}),(0,z.jsx)(`div`,{}),(0,z.jsx)(`div`,{})]}),[...u.tracks].sort((e,t)=>e.trackNumber-t.trackNumber).map((e,t)=>(0,z.jsx)(Re,{song:e,index:t,showAlbum:!1},e.id))]})]})]}),(0,z.jsxs)(`div`,{style:{position:`fixed`,left:0,right:0,bottom:0,background:`#0f1117`,borderTop:`1px solid #202636`,display:`grid`,gridTemplateColumns:`minmax(220px, 320px) minmax(320px, 1fr) minmax(260px, 360px)`,alignItems:`center`,gap:`18px`,padding:`14px 18px`},children:[(0,z.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`12px`,minWidth:0},children:n?(0,z.jsxs)(z.Fragment,{children:[(0,z.jsx)(`img`,{src:n.cover,alt:n.title,style:{width:`58px`,height:`58px`,objectFit:`cover`,borderRadius:`12px`}}),(0,z.jsxs)(`div`,{style:{minWidth:0},children:[(0,z.jsx)(`div`,{style:{fontWeight:700,whiteSpace:`nowrap`,overflow:`hidden`,textOverflow:`ellipsis`},children:n.title}),(0,z.jsx)(`div`,{style:{color:`#9aa2ad`,fontSize:`14px`,textAlign:`left`},children:n.artist})]})]}):(0,z.jsx)(`div`,{style:{color:`#8f8f8f`},children:`Wähle einen Song aus.`})}),(0,z.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:`10px`,minWidth:0},children:[(0,z.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`12px`},children:[(0,z.jsx)(`button`,{onClick:Oe,style:fr,children:`⏮`}),(0,z.jsx)(`button`,{onClick:Me,style:pr,children:m?`❚❚`:`▶`}),(0,z.jsx)(`button`,{onClick:De,style:fr,children:`⏭`}),(0,z.jsx)(`button`,{onClick:Ie,style:{...fr,color:M===`off`?`#9aa2ad`:M===`all`?`#1db954`:`#ffffff`,fontWeight:700,fontSize:`14px`,minWidth:`52px`},children:M===`one`?`R1`:`R`})]}),(0,z.jsxs)(`div`,{style:{width:`100%`,maxWidth:`680px`,display:`grid`,gridTemplateColumns:`52px 1fr 52px`,gap:`12px`,alignItems:`center`},children:[(0,z.jsx)(`div`,{style:{color:`#9aa2ad`,fontSize:`13px`,textAlign:`right`},children:Ae(D)}),(0,z.jsxs)(`div`,{style:{position:`relative`,height:`18px`,display:`flex`,alignItems:`center`},children:[(0,z.jsx)(`div`,{style:{position:`absolute`,left:0,right:0,height:`4px`,borderRadius:`999px`,background:`#2b2f3a`}}),(0,z.jsx)(`div`,{style:{position:`absolute`,left:0,width:`${ee}%`,height:`4px`,borderRadius:`999px`,background:`#ffffff`,pointerEvents:`none`}}),(0,z.jsx)(`input`,{type:`range`,min:`0`,max:`100`,step:`0.1`,value:ee,onChange:Ne,style:mr})]}),(0,z.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`10px`},children:[(0,z.jsx)(`div`,{style:{color:`#9aa2ad`,fontSize:`13px`},children:Ae(te)}),(0,z.jsx)(`button`,{onClick:Pe,style:{background:`transparent`,border:`1px solid #2a3142`,color:`white`,borderRadius:`10px`,padding:`4px 8px`,cursor:n?`pointer`:`default`,fontSize:`12px`,opacity:n?1:.5},children:`Text`})]})]}),(0,z.jsx)(`audio`,{ref:F,autoPlay:!0,src:n?.file||void 0,style:{display:`none`}},n?.id||`empty-player`)]}),(0,z.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`140px minmax(0, 1fr)`,alignItems:`center`,gap:`16px`,minWidth:0},children:[(0,z.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`10px`,justifyContent:`flex-start`,minWidth:0},children:[(0,z.jsx)(`button`,{onClick:Fe,style:{background:`transparent`,border:`none`,color:`#ffffff`,fontSize:`14px`,cursor:`pointer`,padding:0,lineHeight:1},children:O===0?`🔇`:`🔊`}),(0,z.jsx)(`input`,{type:`range`,min:`0`,max:`1`,step:`0.01`,value:O,onChange:e=>{let t=Number(e.target.value);ae(t),t>0&&k(t)},style:{...hr,background:`linear-gradient(
      90deg,
      #1db954 ${O*100}%,
      #2b2f3a ${O*100}%
    )`}})]}),(0,z.jsx)(`div`,{style:{textAlign:`right`,color:`#9aa2ad`,fontSize:`14px`,whiteSpace:`nowrap`,overflow:`hidden`,textOverflow:`ellipsis`,minWidth:0},children:i.length>0?`Als Nächstes: ${i[0].title}`:`Keine Songs in der Warteschlange`})]}),`      `]}),A&&(0,z.jsxs)(z.Fragment,{children:[(0,z.jsx)(`div`,{onClick:()=>se(!1),style:{position:`fixed`,inset:0,background:`rgba(0,0,0,0.55)`,zIndex:70}}),(0,z.jsxs)(`div`,{style:{position:`fixed`,top:`50%`,left:`50%`,transform:`translate(-50%, -50%)`,width:`min(700px, 90vw)`,maxHeight:`70vh`,overflowY:`auto`,background:`#111318`,border:`1px solid #202636`,borderRadius:`22px`,padding:`24px`,zIndex:71,boxShadow:`0 20px 50px rgba(0,0,0,0.45)`},children:[(0,z.jsxs)(`div`,{style:{position:`relative`,marginBottom:`18px`},children:[(0,z.jsxs)(`div`,{style:{textAlign:`center`},children:[(0,z.jsx)(`div`,{style:{color:`#8e96a3`,fontSize:`13px`,marginBottom:`6px`},children:`Liedtext`}),(0,z.jsx)(`div`,{style:{fontSize:`24px`,fontWeight:800},children:n?.title||`Unbekannter Song`})]}),(0,z.jsx)(`button`,{onClick:()=>se(!1),style:{position:`absolute`,top:0,right:0,width:`42px`,height:`42px`,borderRadius:`12px`,border:`1px solid #2a3142`,background:`#171b24`,color:`white`,cursor:`pointer`,fontSize:`18px`},children:`✕`})]}),(0,z.jsx)(`div`,{style:{whiteSpace:`pre-wrap`,lineHeight:1.8,color:`#d7dce4`,fontSize:`15px`},children:ce})]})]}),P&&(0,z.jsxs)(z.Fragment,{children:[(0,z.jsx)(`div`,{onClick:()=>le(!1),style:{position:`fixed`,inset:0,background:`rgba(0,0,0,0.55)`,zIndex:72}}),(0,z.jsxs)(`div`,{style:{position:`fixed`,top:`50%`,left:`50%`,transform:`translate(-50%, -50%)`,width:`min(520px, 90vw)`,background:`#111318`,border:`1px solid #202636`,borderRadius:`22px`,padding:`24px`,zIndex:73,boxShadow:`0 20px 50px rgba(0,0,0,0.45)`},children:[(0,z.jsxs)(`div`,{style:{position:`relative`,marginBottom:`18px`},children:[(0,z.jsxs)(`div`,{style:{textAlign:`center`},children:[(0,z.jsx)(`div`,{style:{color:`#8e96a3`,fontSize:`13px`,marginBottom:`6px`},children:`Community`}),(0,z.jsx)(`div`,{style:{fontSize:`24px`,fontWeight:800},children:`Song einreichen`})]}),(0,z.jsx)(`button`,{onClick:()=>le(!1),style:{position:`absolute`,top:0,right:0,width:`42px`,height:`42px`,borderRadius:`12px`,border:`1px solid #2a3142`,background:`#171b24`,color:`white`,cursor:`pointer`,fontSize:`18px`},children:`✕`})]}),(0,z.jsxs)(`div`,{style:{color:`#d7dce4`,lineHeight:1.7,fontSize:`15px`,textAlign:`center`,marginBottom:`22px`},children:[`Du kannst hier anonym einen Song zur Überprüfung einreichen.`,(0,z.jsx)(`br`,{}),`Das Formular öffnet sich in einem neuen Tab.`]}),(0,z.jsx)(`div`,{style:{display:`flex`,justifyContent:`center`},children:(0,z.jsx)(`a`,{href:ir,target:`_blank`,rel:`noreferrer`,style:{...or,textDecoration:`none`,display:`inline-flex`,alignItems:`center`,justifyContent:`center`},children:`Formular öffnen`})})]})]})]})}var fr={width:`38px`,height:`38px`,borderRadius:`999px`,border:`none`,background:`transparent`,color:`white`,cursor:`pointer`,fontSize:`18px`},pr={width:`44px`,height:`44px`,borderRadius:`999px`,border:`none`,background:`white`,color:`black`,cursor:`pointer`,fontSize:`18px`,fontWeight:700},mr={width:`100%`,appearance:`none`,WebkitAppearance:`none`,background:`transparent`,position:`relative`,zIndex:2,cursor:`pointer`,margin:0},hr={width:`100%`,appearance:`none`,WebkitAppearance:`none`,background:`linear-gradient(90deg, rgb(0, 19, 6) 0%, rgb(9, 105, 0) 100%)`,height:`4px`,borderRadius:`999px`,cursor:`pointer`,margin:0},gr=e=>({background:`transparent`,color:`#9aa2ad`,border:`none`,cursor:e?`grabbing`:`grab`,fontSize:`16px`,padding:0,lineHeight:1}),_r={width:`32px`,height:`32px`,background:`transparent`,color:`#c7ced9`,border:`none`,borderRadius:`8px`,cursor:`pointer`,fontSize:`16px`};(0,v.createRoot)(document.getElementById(`root`)).render((0,z.jsx)(_.StrictMode,{children:(0,z.jsx)(dr,{})}));